...
export const defaultNotificationThemeColors: Record<NotificationType, NotificationColorScheme> = {
  info: {
    ...
    titleText: 'text-[var(--tiger-notification-info-title,var(--tiger-text,#111827))]',
    descriptionText:
  ...
  success: {
    ...
    titleText: 'text-[var(--tiger-notification-success-title,var(--tiger-text,#111827))]',
    descriptionText:
  ...
  warning: {
    ...
    titleText: 'text-[var(--tiger-notification-warning-title,var(--tiger-text,#111827))]',
    descriptionText:
  ...
  error: {
    ...
    titleText: 'text-[var(--tiger-notification-error-title,var(--tiger-text,#111827))]',
    descriptionText:
