...
export const getRadioDotClasses = ({ size, checked, colors }: GetRadioDotClassesOptions) =>
  classNames(
    radioDotBaseClasses,
...
export const getRadioLabelClasses = ({ size, disabled, colors }: GetRadioLabelClassesOptions) =>
  classNames(
