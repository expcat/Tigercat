...
export const descriptionsHeaderClasses =
  "flex items-center justify-between mb-4";

export const descriptionsTitleClasses =
  "text-lg font-semibold text-[var(--tiger-text,#111827)]";

export const descriptionsExtraClasses =
  "text-sm text-[var(--tiger-text-muted,#6b7280)]";
...
export const descriptionsLabelBorderedClasses =
  "border border-[var(--tiger-border,#e5e7eb)]";

export const descriptionsContentClasses = "text-[var(--tiger-text,#111827)]";

export const descriptionsContentBorderedClasses =
  "border border-[var(--tiger-border,#e5e7eb)]";
 ...
 */
export const descriptionsVerticalContentClasses =
