...
export const ptBR: TigerLocale = {
  ...
  workflowTimeline: {
    ...
    actionComment: 'Comentário',
    actionAddsign: 'Adicionar aprovador',
    actionReturn: 'Devolver',
    actionRequestChanges: 'Solicitar alterações',
    addsignBefore: 'Antes',
    addsignAfter: 'Depois',
    addsignTag: 'Aprovador adicionado',
    confirmAddsign: 'Adicionar um aprovador?',
    confirmAddsignDescription: 'A pessoa adicionada aprovará em um nó temporário.',
    confirmReturn: 'Devolver esta solicitação?',
    confirmReturnDescription: 'A instância permanece aberta e reinicia no nó selecionado.',
    confirmRequestChanges: 'Solicitar alterações?',
    confirmRequestChangesDescription: 'O iniciador pode editar esta instância e reenviar.',
    returnPickerTitle: 'Devolver para',
    returnNoTargets: 'Não há nó para o qual devolver.',
    returnResumeResequence: 'Reaprovar em sequência',
    returnResumeDirect: 'Retomar no nó atual',
    fieldEditable: 'Editável',
    fieldReadonly: 'Somente leitura',
    fieldHidden: 'Oculto',
    autoDecideManual: 'Manualmente',
    autoDecideAutoPass: 'Aprovar automaticamente',
    autoDecideAutoReject: 'Rejeitar automaticamente',
    emptyApproverSkipPass: 'Pular e aprovar',
    emptyApproverPause: 'Pausar',
    emptyApproverTransferAdmin: 'Transferir para o admin',
    emptyApproverTransferUser: 'Transferir para o usuário',
    moreActions: 'Mais',
    taskBlocked: 'Aguardando aprovador adicionado',
    commentRequiredBlock: 'Um comentário é obrigatório'
  },
  workflowDesigner: {
    ...
    titleLabel: 'Título',
    titlePlaceholder: 'Título da etapa',
    kindLabel: 'Tipo',
    ...
    tabApprovers: 'Aprovadores',
    tabButtons: 'Botões de ação',
    tabFieldPermissions: 'Permissões do formulário',
    tabAdvanced: 'Avançado',
    copyStep: 'Copiar',
    paletteAriaLabel: 'Inserir nó',
    inspectorEmpty: 'Selecione um nó para editar',
    validationAriaLabel: 'Verificações de publicação',
    validationMissingStart: 'Adicione um nó inicial',
    validationMissingEnd: 'Adicione um nó final',
    validationEmptyApprovers: 'Este nó de aprovação não tem aprovadores',
    validationMissingBranches: 'Este nó de condição não tem ramificações',
    validationButtonsAllDisabled: 'Todos os botões de ação estão desativados',
    sourceLabel: 'Origem dos aprovadores',
    sourceFixed: 'Membros indicados',
    sourceSelf: 'Solicitante',
    sourceStarterPick: 'O solicitante escolhe',
    sourceRole: 'Função',
    sourceGroup: 'Grupo',
    sourceDeptLeader: 'Líder do departamento',
    sourceManagerChain: 'Cadeia de gestores',
    sourceKeyLabel: 'Chave de referência',
    sourceKeyPlaceholder: 'Chave',
    sourceLevelLabel: 'Nível',
    sourceUpToLabel: 'Níveis acima',
    sourceMultiple: 'Permitir vários',
    emptyApproverLabel: 'Quando ninguém é resolvido',
    actorIdPlaceholder: 'Id do membro',
    buttonEnabled: 'Ativado',
    buttonDisplayName: 'Nome de exibição',
    buttonCommentRequired: 'Comentário obrigatório',
    buttonPlacement: 'Posição',
    buttonPlacementBar: 'Barra',
    buttonPlacementMore: 'Mais',
    addsignPositions: 'Posição de adicionar aprovador',
    fieldPermissionsEmpty: 'Passe um schema inicial para editar as permissões',
    fieldPermissionAll: 'Todos',
    timeoutActionLabel: 'Ao expirar',
    timeoutDurationLabel: 'Duração do tempo limite',
    timeoutRemind: 'Lembrar',
    autoDecideLabel: 'Decisão automática',
    addBranch: 'Adicionar ramificação',
    removeBranch: 'Remover ramificação',
    branchLabel: 'Rótulo da ramificação',
  ...
  imageEditor: {
    ...
    loadAnnotationErrorAriaLabel: 'Falha ao carregar a imagem para anotação',
    defaultAnnotationAlt: 'Imagem para anotar',
    annotationShapeAriaLabel: 'anotação {type}',
    annotationLabeledShapeAriaLabel: '{label}, anotação {type}',
  ...
  markdownEditor: {
    ...
    placeholderEmphasis: 'ênfase',
    placeholderDeleted: 'texto excluído',
    placeholderCode: 'código',
    placeholderHeading: 'Título',
    placeholderQuote: 'Citação',
