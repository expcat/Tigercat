...
export const thTH: TigerLocale = {
  ...
  workflowTimeline: {
    ...
    actionTransfer: 'โอน',
    actionCancel: 'ถอน',
    actionComment: 'ความเห็น',
    actionAddsign: 'เพิ่มผู้อนุมัติ',
    actionReturn: 'ส่งกลับ',
    actionRequestChanges: 'ขอให้แก้ไข',
    addsignBefore: 'เพิ่มก่อน',
    addsignAfter: 'เพิ่มหลัง',
    addsignTag: 'ผู้อนุมัติเพิ่ม',
    confirmAddsign: 'เพิ่มผู้อนุมัติ?',
    confirmAddsignDescription: 'ผู้ที่เพิ่มจะอนุมัติบนโหนดชั่วคราว',
    confirmReturn: 'ส่งคำขอนี้กลับ?',
    confirmReturnDescription: 'อินสแตนซ์ยังดำเนินต่อ และเริ่มใหม่จากโหนดที่เลือก',
    confirmRequestChanges: 'ขอให้แก้ไข?',
    confirmRequestChangesDescription: 'ผู้เริ่มสามารถแก้ไขอินสแตนซ์นี้แล้วส่งใหม่ได้',
    returnPickerTitle: 'ส่งกลับไปยัง',
    returnNoTargets: 'ไม่มีโหนดที่ส่งกลับได้',
    returnResumeResequence: 'อนุมัติใหม่ตามลำดับ',
    returnResumeDirect: 'ดำเนินการต่อที่โหนดปัจจุบัน',
    fieldEditable: 'แก้ไขได้',
    fieldReadonly: 'อ่านอย่างเดียว',
    fieldHidden: 'ซ่อน',
    autoDecideManual: 'ด้วยตนเอง',
    autoDecideAutoPass: 'อนุมัติอัตโนมัติ',
    autoDecideAutoReject: 'ปฏิเสธอัตโนมัติ',
    emptyApproverSkipPass: 'ข้ามแล้วผ่าน',
    emptyApproverPause: 'หยุดชั่วคราว',
    emptyApproverTransferAdmin: 'โอนให้ผู้ดูแล',
    emptyApproverTransferUser: 'โอนให้ผู้ที่กำหนด',
    moreActions: 'เพิ่มเติม',
    taskBlocked: 'รอผู้อนุมัติที่เพิ่ม',
    commentRequiredBlock: 'ต้องระบุความเห็น'
  },
  workflowDesigner: {
    ...
    tabApprovers: 'ผู้อนุมัติ',
    tabButtons: 'ปุ่มการทำงาน',
    tabFieldPermissions: 'สิทธิ์ฟอร์ม',
    tabAdvanced: 'ขั้นสูง',
    copyStep: 'คัดลอก',
    paletteAriaLabel: 'แทรกโหนด',
    inspectorEmpty: 'เลือกโหนดเพื่อแก้ไข',
    validationAriaLabel: 'การตรวจสอบก่อนเผยแพร่',
    validationMissingStart: 'เพิ่มโหนดเริ่มต้น',
    validationMissingEnd: 'เพิ่มโหนดสิ้นสุด',
    validationEmptyApprovers: 'โหนดอนุมัตินี้ไม่มีผู้อนุมัติ',
    validationMissingBranches: 'โหนดเงื่อนไขนี้ไม่มีสาขา',
    validationButtonsAllDisabled: 'ปุ่มการทำงานถูกปิดทั้งหมด',
    sourceLabel: 'แหล่งผู้อนุมัติ',
    sourceFixed: 'สมาชิกที่ระบุ',
    sourceSelf: 'ผู้ยื่นเรื่อง',
    sourceStarterPick: 'ผู้ยื่นเรื่องเลือกเอง',
    sourceRole: 'บทบาท',
    sourceGroup: 'กลุ่ม',
    sourceDeptLeader: 'หัวหน้าแผนก',
    sourceManagerChain: 'สายผู้จัดการ',
    sourceKeyLabel: 'คีย์อ้างอิง',
    sourceKeyPlaceholder: 'คีย์',
    sourceLevelLabel: 'ระดับ',
    sourceUpToLabel: 'จำนวนระดับขึ้น',
    sourceMultiple: 'อนุญาตหลายคน',
    emptyApproverLabel: 'เมื่อไม่มีผู้อนุมัติ',
    actorIdPlaceholder: 'รหัสสมาชิก',
    buttonEnabled: 'เปิดใช้',
    buttonDisplayName: 'ชื่อที่แสดง',
    buttonCommentRequired: 'ต้องมีความเห็น',
    buttonPlacement: 'ตำแหน่ง',
    buttonPlacementBar: 'แถบ',
    buttonPlacementMore: 'เพิ่มเติม',
    addsignPositions: 'ตำแหน่งเพิ่มผู้อนุมัติ',
    fieldPermissionsEmpty: 'ส่งสคีมาเริ่มต้นเพื่อแก้ไขสิทธิ์ฟอร์ม',
    fieldPermissionAll: 'ทั้งหมด',
    timeoutActionLabel: 'เมื่อหมดเวลา',
    timeoutDurationLabel: 'ระยะหมดเวลา',
    timeoutRemind: 'เตือน',
    autoDecideLabel: 'ตัดสินใจอัตโนมัติ',
    addBranch: 'เพิ่มสาขา',
    removeBranch: 'ลบสาขา',
    branchLabel: 'ป้ายสาขา',
