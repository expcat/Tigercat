...
export const idID: TigerLocale = {
  ...
  workflowTimeline: {
    ...
    returnTarget: 'Dikembalikan ke sini',
    ...
    actionReject: 'Tolak',
    actionTransfer: 'Alihkan',
    actionCancel: 'Tarik',
    actionComment: 'Komentar',
    actionAddsign: 'Tambah pemberi persetujuan',
    actionReturn: 'Kembalikan',
    actionRequestChanges: 'Minta perubahan',
    addsignBefore: 'Tambah sebelum',
    addsignAfter: 'Tambah sesudah',
    addsignTag: 'Persetujuan tambahan',
    confirmAddsign: 'Tambah pemberi persetujuan?',
    confirmAddsignDescription: 'Orang yang ditambahkan akan menyetujui pada simpul sementara.',
    confirmReturn: 'Kembalikan permintaan ini?',
    confirmReturnDescription: 'Instans tetap berjalan dan dilanjutkan dari simpul yang dipilih.',
    confirmRequestChanges: 'Minta perubahan?',
    confirmRequestChangesDescription: 'Pemohon dapat mengedit instans ini lalu mengirim ulang.',
    returnPickerTitle: 'Kembalikan ke',
    returnNoTargets: 'Tidak ada simpul yang dapat dikembalikan.',
    returnResumeResequence: 'Setujui ulang berurutan',
    returnResumeDirect: 'Lanjutkan di simpul saat ini',
    fieldEditable: 'Dapat diedit',
    fieldReadonly: 'Hanya baca',
    fieldHidden: 'Tersembunyi',
    autoDecideManual: 'Secara manual',
    autoDecideAutoPass: 'Otomatis setujui',
    autoDecideAutoReject: 'Otomatis tolak',
    emptyApproverSkipPass: 'Lewati dan lulus',
    emptyApproverPause: 'Jeda',
    emptyApproverTransferAdmin: 'Alihkan ke admin',
    emptyApproverTransferUser: 'Alihkan ke pengguna',
    moreActions: 'Lainnya',
    taskBlocked: 'Menunggu pemberi persetujuan tambahan',
    commentRequiredBlock: 'Komentar wajib diisi'
  },
  workflowDesigner: {
    ...
    tabApprovers: 'Pemberi persetujuan',
    tabButtons: 'Tombol tindakan',
    tabFieldPermissions: 'Izin formulir',
    tabAdvanced: 'Lanjutan',
    copyStep: 'Salin',
    paletteAriaLabel: 'Sisipkan simpul',
    inspectorEmpty: 'Pilih simpul untuk diedit',
    validationAriaLabel: 'Pemeriksaan publikasi',
    validationMissingStart: 'Tambah simpul mulai',
    validationMissingEnd: 'Tambah simpul selesai',
    validationEmptyApprovers: 'Simpul persetujuan ini tidak punya pemberi persetujuan',
    validationMissingBranches: 'Simpul kondisi ini tidak punya cabang',
    validationButtonsAllDisabled: 'Semua tombol tindakan dinonaktifkan',
    sourceLabel: 'Sumber pemberi persetujuan',
    sourceFixed: 'Anggota yang ditentukan',
    sourceSelf: 'Pemohon',
    sourceStarterPick: 'Pemohon memilih',
    sourceRole: 'Peran',
    sourceGroup: 'Grup',
    sourceDeptLeader: 'Kepala departemen',
    sourceManagerChain: 'Rantai atasan',
    sourceKeyLabel: 'Kunci referensi',
    sourceKeyPlaceholder: 'Kunci',
    sourceLevelLabel: 'Tingkat',
    sourceUpToLabel: 'Tingkat ke atas',
    sourceMultiple: 'Izinkan lebih dari satu',
    emptyApproverLabel: 'Jika tidak ada yang ditemukan',
    actorIdPlaceholder: 'Id anggota',
    buttonEnabled: 'Aktif',
    buttonDisplayName: 'Nama tampilan',
    buttonCommentRequired: 'Komentar wajib',
    buttonPlacement: 'Penempatan',
    buttonPlacementBar: 'Bilah',
    buttonPlacementMore: 'Lainnya',
    addsignPositions: 'Posisi penambah persetujuan',
    fieldPermissionsEmpty: 'Berikan skema awal untuk mengedit izin formulir',
    fieldPermissionAll: 'Semua',
    timeoutActionLabel: 'Saat waktu habis',
    timeoutDurationLabel: 'Durasi batas waktu',
    timeoutRemind: 'Ingatkan',
    autoDecideLabel: 'Keputusan otomatis',
    addBranch: 'Tambah cabang',
    removeBranch: 'Hapus cabang',
    branchLabel: 'Label cabang',
