...
export const jaJP: TigerLocale = {
  ...
  workflowTimeline: {
    ...
    actionCancel: '取り消し',
    actionComment: 'コメント',
    actionAddsign: '承認者を追加',
    actionReturn: '差戻し',
    actionRequestChanges: '修正を依頼',
    addsignBefore: '前に追加',
    addsignAfter: '後に追加',
    addsignTag: '追加承認',
    confirmAddsign: '承認者を追加しますか？',
    confirmAddsignDescription: '追加された人は一時ノードで承認します。',
    confirmReturn: 'この申請を差し戻しますか？',
    confirmReturnDescription: 'インスタンスは継続し、選択したノードから再開します。',
    confirmRequestChanges: '修正を依頼しますか？',
    confirmRequestChangesDescription: '起票者はこのインスタンスを編集して再提出できます。',
    returnPickerTitle: '差戻し先',
    returnNoTargets: '差し戻せるノードがありません。',
    returnResumeResequence: '順に再承認',
    returnResumeDirect: '現在のノードから再開',
    fieldEditable: '編集可',
    fieldReadonly: '読み取り専用',
    fieldHidden: '非表示',
    autoDecideManual: '手動',
    autoDecideAutoPass: '自動承認',
    autoDecideAutoReject: '自動却下',
    emptyApproverSkipPass: 'スキップして通過',
    emptyApproverPause: '一時停止',
    emptyApproverTransferAdmin: '管理者へ転送',
    emptyApproverTransferUser: '指定者へ転送',
    moreActions: 'その他',
    taskBlocked: '追加承認の待ち',
    commentRequiredBlock: 'コメントが必要です'
  },
  workflowDesigner: {
    ariaLabel: 'ワークフロー設計',
    addStep: 'ステップを追加',
    ...
    tabApprovers: '承認者',
    tabButtons: '操作ボタン',
    tabFieldPermissions: 'フォーム権限',
    tabAdvanced: '詳細',
    copyStep: '複製',
    paletteAriaLabel: 'ノードを挿入',
    inspectorEmpty: 'ノードを選んで編集',
    validationAriaLabel: '公開前チェック',
    validationMissingStart: '開始ノードを追加してください',
    validationMissingEnd: '終了ノードを追加してください',
    validationEmptyApprovers: 'この承認ノードに承認者がいません',
    validationMissingBranches: 'この条件ノードに分岐がありません',
    validationButtonsAllDisabled: '操作ボタンがすべて無効です',
    sourceLabel: '承認者の取得元',
    sourceFixed: '指定メンバー',
    sourceSelf: '申請者本人',
    sourceStarterPick: '申請者が選択',
    sourceRole: 'ロール',
    sourceGroup: 'グループ',
    sourceDeptLeader: '部門責任者',
    sourceManagerChain: '連続上長',
    sourceKeyLabel: '参照キー',
    sourceKeyPlaceholder: 'キー',
    sourceLevelLabel: '階層',
    sourceUpToLabel: '上位レベル数',
    sourceMultiple: '複数選択を許可',
    emptyApproverLabel: '承認者が空のとき',
    actorIdPlaceholder: 'メンバー ID',
    buttonEnabled: '有効',
    buttonDisplayName: '表示名',
    buttonCommentRequired: 'コメント必須',
    buttonPlacement: '配置',
    buttonPlacementBar: 'バー',
    buttonPlacementMore: 'その他',
    addsignPositions: '追加承認の位置',
    fieldPermissionsEmpty: '開始スキーマを渡すとフォーム権限を編集できます',
    fieldPermissionAll: 'すべて',
    timeoutActionLabel: 'タイムアウト時',
    timeoutDurationLabel: 'タイムアウト時間',
    timeoutRemind: '通知',
    autoDecideLabel: '自動承認/却下',
    addBranch: '分岐を追加',
    removeBranch: '分岐を削除',
    branchLabel: '分岐名',
    branchExpression: '式',
