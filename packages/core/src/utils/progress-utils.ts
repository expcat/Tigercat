...
export const progressTextBaseClasses =
  'font-medium ml-2 text-[var(--tiger-text,#374151)]';

export const progressCircleBaseClasses =
...
export const progressStripedAnimationClasses =
...
export const progressCircleTextClasses =
  'absolute inset-0 flex items-center justify-center';

export const progressCircleTrackStrokeClasses =
  'text-[var(--tiger-border,#e5e7eb)]';
