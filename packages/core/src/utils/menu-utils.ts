 ...
 */
export const menuItemBaseClasses = 'flex items-center px-4 py-2 cursor-pointer transition-colors duration-200 select-none'
 ...
 */
export const menuItemSelectedLightClasses = 'bg-[var(--tiger-primary,#2563eb)] bg-opacity-10 text-[var(--tiger-primary,#2563eb)] font-medium'

/**
 * Menu item selected classes - dark theme
 */
export const menuItemSelectedDarkClasses = 'bg-[var(--tiger-primary,#2563eb)] text-white font-medium'
 ...
 */
export const submenuTitleClasses = 'flex items-center justify-between px-4 py-2 cursor-pointer transition-colors duration-200 select-none'
 ...
 */
export const submenuContentHorizontalClasses = 'absolute left-0 top-full mt-0 min-w-[160px] bg-white border border-gray-200 rounded shadow-lg z-50'

/**
 * Submenu content classes - vertical/inline mode
 */
export const submenuContentVerticalClasses = 'overflow-hidden transition-all duration-200'

/**
 * Menu item group title classes
 */
export const menuItemGroupTitleClasses = 'px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider'
 ...
 */
export function getMenuItemIndent(level: number, inlineIndent: number = 24): Record<string, string> {
  return {
