...
export const TimePicker: React.FC<TimePickerProps> = (allProps) => {
  ...
  const [internalRangeValue, setInternalRangeValue] = useState<TimePickerRangeValue>(() => {
    const dv = defaultValue
      ...
      {isOpen && (
        <div
          ...
          <div className={timePickerPanelContentClasses}>
            ...
            {/* Minutes column */}
            <div className={timePickerColumnClasses}>
              <div className={timePickerColumnHeaderClasses}>{labels.minute}</div>
              <div className={timePickerColumnListClasses}>
            ...
            {showSeconds && (
              <div className={timePickerColumnClasses}>
                <div className={timePickerColumnHeaderClasses}>{labels.second}</div>
                <div className={timePickerColumnListClasses}>
