          ...
          <div className={activityItemBodyClasses}>
            <div className={activityItemHeaderClasses}>
              <div className={activityItemTitleGroupClasses}>
                {titleText ? (
                  <Text tag="div" size="sm" weight="semibold" className="text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer truncate">
                    {titleText}
                  </Text>
                ) : null}
                {item.status ? (
              ...
              {timeText ? (
                <Text tag="div" size="xs" color="muted" className="shrink-0 whitespace-nowrap font-medium text-gray-400 dark:text-gray-500">
                  {timeText}
                </Text>
              ) : null}
            </div>
      ...
      <div
        ...
        >
          <div className="flex flex-col items-center justify-center py-12 px-4">
            <svg className="w-12 h-12 text-gray-300 dark:text-gray-600 mb-3 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h10.5m-10.5 3h10.5m-13.5-9h16.5M3 5.25h18M3 18.75h18" />
            </svg>
            ...
            {showGroupTitle && groupTitle
              ? (headerNode ?? (
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <Text tag="span" size="sm" weight="bold" className="text-gray-900 dark:text-gray-100 uppercase tracking-wider">
                      {groupTitle}
                    </Text>
                  </div>
                ))
              ...
              renderDot={(timelineItem) => {
                ...
                return (
                  <div className="relative flex items-center justify-center w-4 h-4">
                    {pulseClass ? (
                      <span className={`absolute inline-flex h-full w-full rounded-full animate-ping opacity-75 ${pulseClass}`} />
                    ) : null}
