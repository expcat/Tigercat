                ...
                [
                  ...
                  h(
                    ...
                    [
                      // Title
                      slots.title
                        ? h('div', { class: titleClasses.value }, slots.title())
                        : h('div', { class: titleClasses.value }, props.title),
                      // Description
                      props.description &&
                        (slots.description
                          ? h('div', { class: descriptionClasses.value }, slots.description())
                          : h('div', { class: descriptionClasses.value }, props.description)),
                    ]
                  ),
                ]
              ),
