...
<template>
  <div class="max-w-5xl mx-auto p-8">
    ...
    <section class="mb-12">
      ...
      <p class="text-gray-600 mb-6">支持 sm / md / lg 三种尺寸。</p>
      <div class="p-6 bg-gray-50 rounded-lg">
        <Space direction="vertical"
               class="w-full max-w-md">
    ...
    <!-- 自动高度 -->
    <section class="mb-12">
      <h2 class="text-2xl font-bold mb-4">自动高度</h2>
      <p class="text-gray-600 mb-6">通过 autoResize 启用自动高度，可配合 minRows / maxRows 限制范围。</p>
      <div class="p-6 bg-gray-50 rounded-lg">
        <Space direction="vertical"
               class="w-full max-w-md">
    ...
    <!-- 字符计数 -->
    <section class="mb-12">
      <h2 class="text-2xl font-bold mb-4">字符计数</h2>
      <p class="text-gray-600 mb-6">通过 showCount 显示计数，可配合 maxLength 限制最大字符数。</p>
      <div class="p-6 bg-gray-50 rounded-lg">
        <Space direction="vertical"
               class="w-full max-w-md">
          <FormItem label="仅计数">
