  ...
  return (
    <div className="max-w-5xl mx-auto p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">用于展示加载状态，支持多种加载动画样式，可用于页面和区块的加载状态。</p>
      </div>
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">Loading 组件支持 4 种不同的尺寸：sm、md（默认）、lg、xl。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <div className="flex gap-8 items-center justify-center">
            <div className="flex flex-col items-center gap-2">
              <Loading size="sm" />
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">使用 delay 属性可以延迟显示加载器，避免闪烁（延迟 300ms）。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <div className="flex gap-8 items-center justify-center">
            <div className="flex flex-col items-center gap-2">
