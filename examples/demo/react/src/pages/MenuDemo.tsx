...
import { Menu, MenuItem, SubMenu, MenuItemGroup, Divider } from '@tigercat/react'
        ...
        <div className="p-6 bg-gray-50 rounded-lg">
          <div className="bg-white inline-block">
            <Menu selectedKeys={selectedKeys1} onSelect={(key) => setSelectedKeys1([key])}>
              ...
              <MenuItem key="4" disabled>禁用菜单项</MenuItem>
            </Menu>
          </div>
        </div>
      ...
      <section className="mb-12">
        ...
        <div className="p-6 bg-gray-50 rounded-lg">
          <div className="bg-white">
            <Menu mode="horizontal" selectedKeys={selectedKeys2} onSelect={(key) => setSelectedKeys2([key])}>
        ...
        <div className="p-6 bg-gray-50 rounded-lg">
          <div className="bg-white inline-block">
            <Menu selectedKeys={selectedKeys7} onSelect={(key) => setSelectedKeys7([key])}>
              ...
              <MenuItem key="2" icon={userIcon}>用户</MenuItem>
              <SubMenu key="sub1" title="设置" icon={settingsIcon}>
                <MenuItem key="3">常规设置</MenuItem>
                <MenuItem key="4">高级设置</MenuItem>
              </SubMenu>
            </Menu>
          </div>
        </div>
