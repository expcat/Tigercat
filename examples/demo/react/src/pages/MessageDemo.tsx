  ...
  return (
    <div className="max-w-5xl mx-auto p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">全局展示操作反馈信息，支持多种状态、自动关闭、队列管理等功能。</p>
      </div>

      {/* 基本用法 */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">基本用法</h2>
        <p className="text-gray-600 mb-6">最简单的用法，调用 message 方法即可显示消息提示。</p>
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">通过 duration 属性自定义消息显示时间，设置为 0 时不会自动关闭。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <div className="space-x-2">
            <button 
              className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600"
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">设置 closable 为 true 显示关闭按钮，或使用返回的关闭函数。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">模拟表单提交的完整流程。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <button 
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">支持多条消息同时显示，可以一次清空所有消息。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <div className="space-x-2">
            <button 
              className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600"
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">可以通过 onClose 回调函数在消息关闭时执行特定操作（查看控制台）。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <button 
            className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600"
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">可以通过 className 属性添加自定义样式类。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <button 
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">常见的使用场景示例。</p>
      ...
      <div className="mt-12 p-6 bg-blue-50 border border-blue-200 rounded-lg">
        <h3 className="text-lg font-semibold mb-2 text-blue-800">💡 提示</h3>
