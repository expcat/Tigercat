  ...
  return (
    <div className="max-w-5xl mx-auto p-8">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">独立使用徽章展示数字或文本。</p>
      ...
      {/* 徽章大小 */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">徽章大小</h2>
        <p className="text-gray-600 mb-6">徽章有三种尺寸：小、中、大。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <Space align="center">
      ...
      {/* 文本徽章 */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">文本徽章</h2>
        <p className="text-gray-600 mb-6">显示文本内容的徽章。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <Space wrap>
      ...
      {/* 徽章位置 */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">徽章位置</h2>
        <p className="text-gray-600 mb-6">在包裹模式下，可以设置徽章的位置。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
          <Space wrap>
