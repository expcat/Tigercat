...
import { r as parseQuery, l as hasProtocol, p as joinURL, z as withTrailingSlash, A as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
import { _ as _export_sfc, u as useHead } from './_plugin-vue_export-helper-BKz9x_cS.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-43eb0730><div class="fixed left-0 right-0 spotlight z-10" data-v-43eb0730></div><div class="max-w-520px text-center z-20" data-v-43eb0730><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-43eb0730>${ssrInterpolate(__props.status)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-43eb0730>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-43eb0730>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.21.6_@parcel+watcher@2.5.6_@types+node@25.6.0_@vue+compiler-sfc@3.5.34_cac@6.7.1_76d4efd173c0bb09edff2d193077160c/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-43eb0730"]]);

export { error404 as default };
//# sourceMappingURL=error-404-Cx98gIkj.mjs.map
