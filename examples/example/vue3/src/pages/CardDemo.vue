...
<Card size="md">...</Card>
<Card size="lg">...</Card>
<Card :padding="false">...</Card>
<Card padding="p-8">...</Card>`

const hoverSnippet = `<Card hoverable variant="shadow">...</Card>`

const coverSnippet = `<Card cover="..." cover-alt="...">...</Card>`

const structureSnippet = `<Card>
  <template #header>...</template>
  <template #footer>...</template>
  <template #actions>...</template>
</Card>`

const fullSnippet = `<Card variant="shadow" hoverable cover="...">...</Card>`
</script>
    ...
    <DemoBlock title="卡片尺寸与内边距" description="卡片有三种尺寸（主要影响内边距），同时支持 padding 属性完全定制（可为 false 以移除，或传入自定义 Tailwind 类如 p-8）。" :code="sizeSnippet">
      <div class="p-6 bg-gray-50 rounded-lg">
        <Space direction="vertical" :size="16" class="w-full">
          <Card size="sm">
            <h3 class="font-semibold mb-2">小尺寸卡片 (sm)</h3>
            <p class="text-gray-600 dark:text-gray-400">内边距较小，适合紧凑布局。</p>
          </Card>
          <Card size="md">
            <h3 class="font-semibold mb-2">中等尺寸卡片 (md)</h3>
            <p class="text-gray-600 dark:text-gray-400">默认尺寸，适合大多数场景。</p>
          </Card>
          <Card size="lg">
            <h3 class="font-semibold mb-2">大尺寸卡片 (lg)</h3>
            <p class="text-gray-600 dark:text-gray-400">内边距较大，适合重要内容展示。</p>
          </Card>
          <Card :padding="false">
            <div class="bg-blue-50 text-blue-800 p-4 dark:bg-blue-900/30 dark:text-blue-300">
              无内边距卡片 (padding=false)
            </div>
          </Card>
          <Card padding="p-8">
            <h3 class="font-semibold mb-2">自定义大内边距 (padding="p-8")</h3>
            <p class="text-gray-600 dark:text-gray-400">使用自定 class 控制内边距。</p>
          </Card>
        </Space>
      </div>
    </DemoBlock>
      ...
      <div class="p-6 bg-gray-50 rounded-lg">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card
            ...
            <p class="text-gray-600 mb-4">最新的智能科技产品，为您的生活带来便利。</p>
            <template #footer>
              <div class="flex justify-between items-center">
                <span class="text-xl font-bold text-[var(--tiger-primary,#2563eb)]">¥299</span>
                <span class="text-sm text-gray-500">已售 1.2k</span>
              </div>
            </template>
            <template #actions>
          ...
          <Card
            ...
            <p class="text-gray-600 mb-4">为企业提供全方位的数字化转型解决方案。</p>
            <template #footer>
              <div class="flex justify-between items-center">
                <span class="text-xl font-bold text-[var(--tiger-primary,#2563eb)]">¥999</span>
                <span class="text-sm text-gray-500">已售 856</span>
              </div>
            </template>
            <template #actions>
              <Button variant="ghost" size="sm">收藏</Button>
          ...
          <Card
            ...
            <p class="text-gray-600 mb-4">专业团队为您提供一对一的咨询和技术支持。</p>
            <template #footer>
              <div class="flex justify-between items-center">
                <span class="text-xl font-bold text-[var(--tiger-primary,#2563eb)]">¥1999</span>
                <span class="text-sm text-gray-500">已售 562</span>
              </div>
            </template>
            <template #actions>
              <Button variant="ghost" size="sm">收藏</Button>
