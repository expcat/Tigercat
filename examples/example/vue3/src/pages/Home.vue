...
const injectedLang = inject<Ref<DemoLang>>('demo-lang', ref('zh-CN' as DemoLang))
const lang = computed(() => injectedLang.value)
const quickLinks = computed(() => DEMO_NAV_GROUPS.flatMap((g) => g.items).slice(0, 8))
</script>

<template>
  <div class="max-w-5xl">
    <div class="mb-6">
      <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Tigercat Vue 3 示例</h1>
    ...
    <div
      ...
      <div class="text-sm">
        主题色会通过 CSS 变量（如
        <span class="font-mono">--tiger-primary</span>）即时作用于所有组件。
      </div>
    </div>
