...
<template>
  <div class="max-w-5xl mx-auto p-8">
    ...
    <DemoBlock title="不同图标类型"
               description="支持 warning、info、error、success、question 五种图标类型。"
               :code="iconSnippet">
      <div class="p-6 bg-gray-50 rounded-lg">
        <Space>
          <Popconfirm title="这是警告信息"
                      icon="warning">
            <Button>警告</Button>
          </Popconfirm>

          <Popconfirm title="这是提示信息"
                      icon="info">
            <Button>信息</Button>
          </Popconfirm>

          <Popconfirm title="这是错误信息"
                      icon="error">
    ...
    <DemoBlock title="隐藏图标"
               description="通过 showIcon 属性控制图标显示。"
               :code="noIconSnippet">
      <div class="p-6 bg-gray-50 rounded-lg">
        <Popconfirm title="确定要继续吗？"
                    :show-icon="false"
