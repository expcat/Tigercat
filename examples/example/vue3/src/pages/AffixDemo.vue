<template>
  <div class="max-w-5xl mx-auto p-4 sm:p-8">
    ...
    <DemoBlock
      title="固定在顶部与底部固定"
      description="合并展示固定在顶部、底部固定，减少重复示例块。"
      ...
      <div class="space-y-6">
        ...
        <div class="space-y-3">
          <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-200">底部固定</h3>
          <Affix :offset-bottom="20">
            <div class="px-4 py-2 bg-green-500 text-white rounded inline-block">
              距底部 20px 固定
            </div>
          </Affix>
        </div>
...
const topSnippet = `<Affix :offset-top="0" @change="onAffixChange">
  <div class="px-4 py-2 bg-blue-500 text-white rounded">我会固定在顶部</div>
</Affix>`

const bottomSnippet = `<Affix :offset-bottom="20">
  <div class="px-4 py-2 bg-green-500 text-white rounded">距底部 20px 固定</div>
</Affix>`
</script>
