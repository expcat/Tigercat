...
<template>
  <div class="max-w-5xl mx-auto p-8 text-gray-900 dark:text-gray-100">
    <div class="mb-8">
      ...
      <p class="text-gray-600 dark:text-gray-300">用于页面中展示重要的提示信息，支持成功、警告、失败、信息等多种状态。</p>
    </div>
    ...
    <section class="mb-12">
      ...
      <div class="p-6 rounded-xl border border-gray-200 bg-white shadow-sm space-y-4 dark:border-gray-800 dark:bg-gray-900/40">
    ...
    <section class="mb-12">
      ...
      <p class="text-gray-600 dark:text-gray-300 mb-6">Alert 组件支持 4 种不同的类型：info（信息）、success（成功）、warning（警告）、error（错误）。</p>
      <div class="p-6 rounded-xl border border-gray-200 bg-white shadow-sm space-y-4 dark:border-gray-800 dark:bg-gray-900/40">
    ...
    <section class="mb-12">
      ...
      <p class="text-gray-600 dark:text-gray-300 mb-6">Alert 组件支持 3 种不同的尺寸：小、中、大。</p>
      <div class="p-6 rounded-xl border border-gray-200 bg-white shadow-sm space-y-4 dark:border-gray-800 dark:bg-gray-900/40">
    ...
    <section class="mb-12">
      ...
      <p class="text-gray-600 dark:text-gray-300 mb-6">默认情况下会显示图标，可以通过 showIcon 属性控制。</p>
      <div class="p-6 rounded-xl border border-gray-200 bg-white shadow-sm space-y-4 dark:border-gray-800 dark:bg-gray-900/40">
    ...
    <section class="mb-12">
      ...
      <p class="text-gray-600 dark:text-gray-300 mb-6">通过设置 closable 属性可以让 Alert 显示关闭按钮。</p>
      <div class="p-6 rounded-xl border border-gray-200 bg-white shadow-sm space-y-4 dark:border-gray-800 dark:bg-gray-900/40">
        <Alert 
          v-if="showAlert1"
          type="info" 
        ...
        />
        <div v-if="!showAlert1 || !showAlert2" class="text-gray-500 dark:text-gray-400 text-center py-4">
          提示已关闭
          <button 
            class="ml-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-colors"
    ...
    <section class="mb-12">
      ...
      <p class="text-gray-600 dark:text-gray-300 mb-6">使用 description 属性可以添加详细的描述内容。</p>
      <div class="p-6 rounded-xl border border-gray-200 bg-white shadow-sm space-y-4 dark:border-gray-800 dark:bg-gray-900/40">
        <Alert
          type="success"
          title="操作成功"
    ...
    <section class="mb-12">
      ...
      <div class="p-6 rounded-xl border border-gray-200 bg-white shadow-sm space-y-4 dark:border-gray-800 dark:bg-gray-900/40">
        ...
        />
        <div v-if="!showAlert3" class="text-gray-500 dark:text-gray-400 text-center py-4">
          提示已关闭
          <button 
            class="ml-4 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition-colors"
