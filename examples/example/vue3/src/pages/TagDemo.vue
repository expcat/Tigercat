...
const preventCloseSnippet = `<Tag closable @close="$event.preventDefault()">点击关闭按钮不会消失</Tag>`
...
const usageSnippet = `<Space direction="vertical" class="w-full">
  <div>
...
<template>
  <div class="max-w-5xl mx-auto p-4 sm:p-8">
    <div class="mb-8">
      ...
      <p class="text-gray-600 dark:text-gray-400">用于标记和分类的小型标签组件。</p>
    </div>
