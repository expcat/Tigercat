...
<template>
  <div class="max-w-5xl mx-auto p-8">
    ...
    <!-- 进度条变体 -->
    <DemoBlock title="进度条变体"
               description="支持六种颜色变体。"
               :code="variantSnippet">
      <Space direction="vertical"
             class="w-full">
    ...
    <!-- 不显示文字 -->
    <DemoBlock title="不显示文字"
               description="可以隐藏进度条的文本显示。"
               :code="noTextSnippet">
      <Space direction="vertical"
             class="w-full">
        <Progress :percentage="50"
