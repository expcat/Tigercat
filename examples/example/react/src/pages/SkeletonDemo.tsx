...
const animationSnippet = `<Space direction="vertical" size={16} className="w-full">
  <div>
...
const rowsSnippet = `<Space direction="vertical" size={24} className="w-full">
  <div>
...
const paragraphSnippet = `<Space direction="vertical" size={24} className="w-full">
  <div>
...
const sizeSnippet = `<Space direction="vertical" size={16} className="w-full">
  <div>
...
const composeSnippet = `<Space direction="vertical" size={24} className="w-full">
...
const loadingSnippet = `<div className="bg-white p-6 rounded-lg">
  {loading ? (
    <>
...
const realSnippet = `<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  {cardLoading ? (
    <>
      {[1, 2, 3, 4].map((i) => (
        <Card key={i}>
