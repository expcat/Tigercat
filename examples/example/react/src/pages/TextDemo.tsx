...
const tagSnippet = `<Space direction="vertical" className="w-full">
...
const colorSnippet = `<Space direction="vertical" className="w-full">
...
const sizeSnippet = `<Space direction="vertical" align="start" className="w-full">
  <Text size="sm">小号文本</Text>
  <Text size="base">中号文本</Text>
  <Text size="lg">大号文本</Text>
</Space>`

const weightSnippet = `<Space direction="vertical" className="w-full">
  <Text weight="normal">Normal</Text>
  <Text weight="semibold">Semibold</Text>
  <Text weight="bold">Bold</Text>
</Space>`

const alignSnippet = `<div className="grid grid-cols-1 gap-4">
...
const decorateSnippet = `<Space direction="vertical" className="w-full">
  <div className="w-64">
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">文本的基本格式。</p>
      </div>
