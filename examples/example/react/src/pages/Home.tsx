...
const Home: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl">
      ...
      <div className="p-4 rounded-lg border border-blue-200 bg-blue-50 text-blue-900 dark:border-blue-900/50 dark:bg-blue-950/40 dark:text-blue-100">
        <div className="text-sm">
          主题色会通过 CSS 变量（如 <span className="font-mono">--tiger-primary</span>）即时作用于所有组件。
        </div>
      </div>
