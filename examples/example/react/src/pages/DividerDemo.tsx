  ...
  return (
    <div className="max-w-5xl mx-auto p-8">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">lineStyle 支持 solid / dashed / dotted。</p>
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">通过 color / thickness 自定义边框颜色与宽度。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">orientation="vertical" 用于行内内容分隔。</p>
        <div className="p-6 bg-gray-50 rounded-lg">
