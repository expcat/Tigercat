...
import fullPageSnippet from './WatermarkDemo.tsx?raw'
...
const imageSnippet = `<Watermark image={watermarkImage} width={120} height={64} gapX={120} gapY={80}>
  <div style={{ height: 300 }} className="bg-gray-50 rounded-lg p-4">
    <p>使用 image 属性可以展示图片水印。</p>
  </div>
</Watermark>`
...
const WatermarkDemo: React.FC = () => {
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-8">
      ...
      <DemoBlock
        title="图片水印"
        description="通过 image 属性使用图片作为水印"
        code={fullPageSnippet}>
