...
const minSnippet = `<Splitter direction="horizontal" sizes={[30, 70]} min={100}>
  ...
  return (
    <div className="max-w-5xl mx-auto p-8">
      ...
      <DemoBlock title="最小尺寸" description="min 限制面板最小尺寸" code={minSnippet}>
        <Splitter direction="horizontal" sizes={[30, 70]} min={100} style={{ height: 200, border: '1px solid #e5e7eb', borderRadius: 8 }}>
          <div className="p-4">最小宽度面板</div>
          <div className="p-4">主内容区</div>
        </Splitter>
      </DemoBlock>
