    ...
    <>
      <div className="space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            开启 showColumnSettings 后，工具栏右侧出现列设置入口，可勾选控制列显隐；hideable: false
            的列不可隐藏。
          </p>
          <DataTableWithToolbar<UserRow>
        ...
        <section className="space-y-3">
          <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-200">钉列 / 锁定列</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <section className="space-y-3">
          <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-200">工具栏布局定制</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <section className="space-y-3">
          <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-200">卡片自定义渲染</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            把 DataExport 放进
            toolbar.filtersExtra，实现“所见即所导”：导出列跟随列设置的隐藏状态；有选中行时仅导出选中行，否则导出全部数据。
          </p>
          <DataTableWithToolbar<UserRow>
            columns={columns}
