...
- 做表格相关实现：涉及固定列、锁列或虚拟表格时，优先看 [shared/props/data.md](references/shared/props/data.md)、[shared/props/advanced.md](references/shared/props/advanced.md) 以及对应 [examples/data.md](references/examples/data.md) / [examples/advanced.md](references/examples/advanced.md)。
