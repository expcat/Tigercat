...
| Inplace               | Basic      | `basic`      | inplace.ts                                          | ./Inplace               |
...
| SankeyChart           | Charts     | `charts`     | chart-visualization.ts                              | ./SankeyChart           |
...
| NotificationBell      | Composite  | `composite`  | notification-bell.ts                                | ./NotificationBell      |
