...
标准用法 `<Component />`（Vue/React 同名，绑定差异见 `shared/patterns/common.md`）：ColorPicker, ColorSwatch, CronEditor, DatePicker, InputOTP, Mentions, NumberKeyboard, Signature, TagsInput, TimePicker, Transfer, Upload.
