...
标准用法 `<Component />`（Vue/React 同名，绑定差异见 `shared/patterns/common.md`）：Alert, Avatar, AvatarGroup, Badge, ConfigProvider, CropUpload, Divider, Empty, ImageGroup, Rate, Result, Segmented, SplitButton, Statistic, Tag, Watermark.
