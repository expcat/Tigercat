...
标准用法 `<Component />`（Vue/React 同名，绑定差异见 `shared/patterns/common.md`）：Alert, ConfigProvider, CropUpload, Divider, Empty, ImageGroup, Rate, Result, Segmented, SplitButton, Statistic, Watermark.
