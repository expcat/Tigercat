...
const CORE_EXPORT_TARGETS = ['utils', 'types', 'theme-runtime', 'themes', 'tokens', 'tailwind-plugin']
...
const snapshot = sortKeys({
  ...
  vue: { components: componentExports(vueIndex), exports: uniqSorted(extractExportNames(vueIndex)) },
  react: {
