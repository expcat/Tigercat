...
| swipeable?              | `boolean`                                | true     | Whether horizontal touch swipes switch tabs.                          |
| className?              | `string`                                 | -        | Additional CSS classes                                                |
| style?                  | `Record&lt;string, string \| number&gt;` | -        | Custom styles                                                         |
...
| responsiveMode?       | `TableResponsiveMode`                                    | 'scroll'                 | Mobile layout below 640px. `scroll` keeps the table horizontally scrollable; `card` renders each row as a stacked card list.                                                                           |
