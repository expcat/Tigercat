...
- 149 个公开组件均已有有效展示入口；R31-R35 已补齐 10 个高优先级和 8 个中优先级组件的功能展示，当前没有待补充批次。
...
- 当前无实现任务；后续仅按“后续任务登记规则”新增有事实依据的工作。
...
| R35 | 已完成 | InputNumber、OrgChart、Spotlight、VirtualTable     | formatter/parser 与控件布局；纵向/头像及受控选择；自定义过滤、快捷键和禁用项；受控选择、列虚拟化及状态页 |
