...
| **Form**   | 内置校验预设（email/phone/url/id-card）、条件联动 DSL、表单性能优化（大表单 >50 字段） | 高     | 部分完成：内置校验预设、按字段校验、防抖校验 |
| **Select** | 虚拟滚动（>1000 选项）、远程搜索防抖、创建新选项                                       | 高     | 部分完成：虚拟滚动、远程搜索防抖             |
| **Tree**   | 大数据虚拟化（>10000 节点）、节点拖拽排序、搜索高亮                                    | 中     | 待办                                         |
| **Upload** | 断点续传、分片上传、上传队列管理                                                       | 中     | 待办                                         |
| **Menu**   | 菜单搜索过滤、折叠模式增强                                                             | 中     | 待办                                         |
| **Charts** | 数据缩放（brush）、导出 PNG/SVG、图表联动、自适应 resize 增强                          | 中     | 待办                                         |
| **Tour**   | 步骤条件跳过、异步步骤加载、移动端适配                                                 | 低     | 待办                                         |
