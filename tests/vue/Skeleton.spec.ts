...
describe('Skeleton', () => {
  ...
  describe('Accessibility', () => {
    ...
    it('should have no a11y violations with avatar variant', async () => {
      const { container } = renderWithProps(Skeleton, { variant: 'avatar' })
      await expectNoA11yViolations(container)
    })

    it('should have no a11y violations with multiple rows', async () => {
      const { container } = renderWithProps(Skeleton, {
        variant: 'text',
        rows: 3,
      })
  ...
  describe('Snapshots', () => {
    it('should match snapshot for text variant', () => {
      const { container } = renderWithProps(Skeleton, { variant: 'text' })
      expect(container.innerHTML).toMatchSnapshot()
    })

    it('should match snapshot for avatar variant', () => {
      const { container } = renderWithProps(Skeleton, {
        variant: 'avatar',
        shape: 'circle',
      })
    ...
    it('should match snapshot for image variant', () => {
      const { container } = renderWithProps(Skeleton, { variant: 'image' })
      expect(container.innerHTML).toMatchSnapshot()
    })

    it('should match snapshot for button variant', () => {
      const { container } = renderWithProps(Skeleton, { variant: 'button' })
      expect(container.innerHTML).toMatchSnapshot()
    })

    it('should match snapshot for multiple rows', () => {
      const { container } = renderWithProps(Skeleton, {
        variant: 'text',
        rows: 3,
        paragraph: true,
