...
describe('Modal', () => {
  ...
  describe('Props', () => {
    ...
    it('should show mask by default', async () => {
      ...
      await waitFor(() => {
        const mask = container.querySelector('.bg-black')
  ...
  describe('States', () => {
    ...
    it('should destroy content when destroyOnClose is true and modal is closed', async () => {
      ...
      await rerender({ visible: false, destroyOnClose: true, disableTeleport: true })
    ...
    it('should keep content when destroyOnClose is false and modal is closed', async () => {
      ...
      await rerender({ visible: false, destroyOnClose: false, disableTeleport: true })
      
      // Content should still exist in DOM even if not visible
      // This is because destroyOnClose is false
    })
  })
