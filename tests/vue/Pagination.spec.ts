...
describe('Pagination', () => {
  describe('Rendering', () => {
    ...
    it('should hide total text when showTotal is false', () => {
      render(Pagination, {
        props: { total: 100, pageSize: 10, showTotal: false },
      })
    ...
    it('should render custom total text', () => {
      ...
      render(Pagination, {
        props: { total: 100, pageSize: 10, totalText },
      })
  ...
  describe('Page Navigation', () => {
    it('should emit change event when page is clicked', async () => {
    ...
    it('should navigate to previous page', async () => {
      const onChange = vi.fn()
      render(Pagination, {
        props: { total: 100, pageSize: 10, current: 5 },
        attrs: { onChange },
      })
    ...
    it('should disable next button on last page', () => {
      render(Pagination, {
        props: { total: 100, pageSize: 10, current: 10 },
      })
  ...
  describe('Sizes', () => {
    ...
    it('should render medium size', () => {
      const { container } = render(Pagination, {
        props: { total: 100, pageSize: 10, size: 'medium' },
      })
    ...
    it('should render large size', () => {
      const { container } = render(Pagination, {
        props: { total: 100, pageSize: 10, size: 'large' },
      })
  ...
  describe('Alignment', () => {
    it('should align left', () => {
      const { container } = render(Pagination, {
        props: { total: 100, pageSize: 10, align: 'left' },
      })
    ...
    it('should align center', () => {
      const { container } = render(Pagination, {
        props: { total: 100, pageSize: 10, align: 'center' },
      })
    ...
    it('should align right', () => {
      const { container } = render(Pagination, {
        props: { total: 100, pageSize: 10, align: 'right' },
      })
  ...
  describe('Active Page', () => {
    it('should highlight current page', () => {
      render(Pagination, {
        props: { total: 100, pageSize: 10, current: 3 },
      })
  ...
  describe('Page Number Range', () => {
    it('should show ellipsis for large page counts', () => {
      render(Pagination, {
        props: { total: 1000, pageSize: 10, current: 50 },
      })
    ...
    it('should show less items when showLessItems is true', () => {
      const { container: container1 } = render(Pagination, {
        props: { total: 1000, pageSize: 10, current: 50, showLessItems: false },
      })

      const { container: container2 } = render(Pagination, {
        props: { total: 1000, pageSize: 10, current: 50, showLessItems: true },
      })
  ...
  describe('Custom Class', () => {
    it('should apply custom className', () => {
      const { container } = render(Pagination, {
        props: { total: 100, pageSize: 10, className: 'custom-class' },
      })
