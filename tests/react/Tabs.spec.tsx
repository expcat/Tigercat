...
describe('Tabs', () => {
  describe('Rendering', () => {
    it('should render with default props', () => {
      render(
        <Tabs>
          <TabPane tabKey="1" label="Tab 1">Content 1</TabPane>
          <TabPane tabKey="2" label="Tab 2">Content 2</TabPane>
        </Tabs>
      )
  ...
  describe('Props', () => {
    ...
    it('should render tabs in different sizes', () => {
      ...
      sizes.forEach((size) => {
        render(
          <Tabs size={size}>
            <TabPane tabKey="1" label={`Tab ${size}`}>Content 1</TabPane>
          </Tabs>
        )
  ...
  describe('Events', () => {
    ...
    it('should call onEdit when close button is clicked', async () => {
      ...
      const closeButtons = tabs[0].querySelectorAll('svg')
  ...
  describe('TabPane', () => {
    it('should render tab pane with content', () => {
      render(
        <Tabs>
          <TabPane tabKey="1" label="Tab 1">Test Content</TabPane>
        </Tabs>
      )
    ...
    it('should render disabled tab pane', () => {
      render(
        <Tabs>
          <TabPane tabKey="1" label="Tab 1" disabled>Content 1</TabPane>
        </Tabs>
      )
    ...
    it('should not switch to disabled tab when clicked', async () => {
      ...
      render(
        <Tabs activeKey="1" onChange={onChange}>
          <TabPane tabKey="1" label="Tab 1">Content 1</TabPane>
          <TabPane tabKey="2" label="Tab 2" disabled>Content 2</TabPane>
        </Tabs>
      )
    ...
    it('should render tab with icon', () => {
      ...
      render(
        <Tabs>
          <TabPane tabKey="1" label="Tab 1" icon={icon}>Content 1</TabPane>
        </Tabs>
      )
    ...
    it('should override closable prop per tab', () => {
      render(
        <Tabs type="editable-card" closable>
          <TabPane tabKey="1" label="Tab 1" closable={false}>Content 1</TabPane>
          <TabPane tabKey="2" label="Tab 2">Content 2</TabPane>
        </Tabs>
      )
