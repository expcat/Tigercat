...
describe('Checkbox', () => {
  describe('Rendering', () => {
    ...
    it('should apply custom className', () => {
      const { container } = render(<Checkbox className="custom-class">Checkbox</Checkbox>)
  ...
  describe('Events', () => {
    ...
    it('should not call onChange when disabled', async () => {
      const user = userEvent.setup()
      const handleChange = vi.fn()
      const { container } = render(<Checkbox disabled onChange={handleChange}>Disabled</Checkbox>)
    ...
    it('should toggle from false to true', async () => {
      const user = userEvent.setup()
      const handleChange = vi.fn()
      const { container } = render(<Checkbox checked={false} onChange={handleChange}>Toggle</Checkbox>)
    ...
    it('should toggle from true to false', async () => {
      const user = userEvent.setup()
      const handleChange = vi.fn()
      const { container } = render(<Checkbox checked={true} onChange={handleChange}>Toggle</Checkbox>)
