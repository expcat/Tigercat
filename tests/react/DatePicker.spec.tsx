...
describe('DatePicker', () => {
  ...
  describe('Calendar Interaction', () => {
    ...
    it('should display current month and year in calendar header', async () => {
      ...
      await waitFor(() => {
        ...
        const expectedHeader = `${monthNames[currentDate.getMonth()]} ${currentDate.getFullYear()}`
  ...
  describe('Events', () => {
    ...
    it('should call onChange with null when clear button is clicked', async () => {
      ...
      const onChange = vi.fn()
      const { container } = render(
        <DatePicker value={new Date('2024-01-15')} onChange={onChange} clearable={true} />
      )
    ...
    it('should call onClear when clear button is clicked', async () => {
      ...
      const onClear = vi.fn()
      const { container } = render(
        <DatePicker value={new Date('2024-01-15')} onClear={onClear} clearable={true} />
      )
  ...
  describe('Theme Support', () => {
    ...
    it('should support theme customization via CSS variables', () => {
      ...
      const { container } = render(<DatePicker value={new Date('2024-01-15')} />)
      
      expect(container.querySelector('input')).toBeInTheDocument()
      
      const primaryColor = getComputedStyle(document.documentElement).getPropertyValue('--tiger-primary')
