...
describe('Splitter', () => {
  ...
  describe('Keyboard interaction', () => {
    ...
    it('should resize on ArrowLeft key in horizontal mode', () => {
      const onResize = vi.fn()
      const { container } = renderSplitter({
        sizes: [400, 400],
        onResize
    ...
    it('should resize on ArrowDown key in vertical mode', () => {
      const onResize = vi.fn()
      const { container } = renderSplitter({
        direction: 'vertical',
        sizes: [400, 400],
    ...
    it('should not resize on irrelevant keys', () => {
      const onResize = vi.fn()
      const { container } = renderSplitter({
        sizes: [400, 400],
        onResize
