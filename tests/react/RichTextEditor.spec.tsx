...
describe('RichTextEditor', () => {
  ...
  describe('Height', () => {
    ...
    it('merges leftover style with the height box', () => {
      const { container } = renderEditor({ height: 320, style: { marginTop: '8px' } })
      const wrapper = container.firstElementChild as HTMLElement
  ...
  describe('Events', () => {
    ...
    it('should emit plain mode content as text', () => {
      const onChange = vi.fn()
      const { container } = renderEditor({ value: 'Hello', mode: 'plain', onChange })
      const editor = container.querySelector('[role="textbox"]') as HTMLElement
