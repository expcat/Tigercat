...
describe('Alert', () => {
  describe('Rendering', () => {
    ...
    it('should render with description', () => {
      render(
        <Alert title="Alert Title" description="Alert description text" />
      );
    ...
    it('should render with custom title slot', () => {
      render(<Alert titleSlot={<strong>Custom Title</strong>}>Content</Alert>);
    ...
    it('should render with custom description slot', () => {
      render(
        <Alert title="Title" descriptionSlot={<em>Custom Description</em>} />
      );
    ...
    it('should apply custom className', () => {
      const { container } = render(
        <Alert title="Alert" className="custom-class" />
      );
  ...
  describe('Closable', () => {
    ...
    it('should hide alert after close button is clicked', async () => {
      ...
      const { container } = render(<Alert title="Closable Alert" closable />);
  ...
  describe('Multiple Content Types', () => {
    it('should render title and description together', () => {
      render(<Alert title="Main Title" description="Description text" />);
    ...
    it('should render with all features enabled', () => {
      ...
      expect(
        container.querySelector('button[aria-label="Close alert"]')
      ).toBeInTheDocument();
    });

    it('should prioritize titleSlot over title prop', () => {
      render(
        <Alert title="Original Title" titleSlot={<span>Slot Title</span>} />
      );
  ...
  describe('Accessibility', () => {
    ...
    it('should have accessible close button', () => {
      const { container } = render(<Alert title="Alert" closable />);
